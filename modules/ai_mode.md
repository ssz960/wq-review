...
The server SSH path was recovered and the deployed source head is
`3273770cd3b808f9e7be1942d78bb6735eaf6507`. The bounded real Provider preflight
used 10 serialized calls and produced no valid Proposal after empty/non-JSON
responses. Readiness fails closed on the exhausted budget; Provider-generated
Mock execution was not started, and no candidate or execution fact was created.
WQ Gate, real execution, and the legacy `/worldquant` path remain closed.
See `docs/test_reports/provider_generated_mock_e2e_v1_20260722.md`.
